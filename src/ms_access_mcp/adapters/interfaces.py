...
class ISchemaAdapter(IConnectionManager, Protocol):
    ...
    def create_index(self, table_name: str, index_name: str, columns: list[str], unique: bool = False, ignore_nulls: bool = False) -> dict: ...
    def drop_index(self, table_name: str, index_name: str) -> dict: ...
    def create_relationship(self, table_name: str, relationship_name: str,
                           columns: list[str], foreign_table: str,
                           foreign_columns: list[str]) -> dict: ...
...
class IUiAdapter(IConnectionManager, Protocol):
    ...
    # Database-level properties (DAO CurrentDb.Properties)
